...
class ClassificationAdapter(
    ...
    androidx.recyclerview.widget.ListAdapter<Classification, ClassificationAdapter.ClassificationViewHolder>(
        DiffCallback
    ) {
    ...
    override fun onBindViewHolder(holder: ClassificationViewHolder, position: Int) {
        ...
        holder.itemView.delete_classification.setOnClickListener {
            MaterialAlertDialogBuilder(context).setTitle("Delete Item")
                .setMessage("Do you want to completely delete this classification?")
