...
class UpdateInventoryViewModelFactory(private val product: Inventory, private val application: Application,private val inventoryRepository: InventoryRepository): ViewModelProvider.Factory {
